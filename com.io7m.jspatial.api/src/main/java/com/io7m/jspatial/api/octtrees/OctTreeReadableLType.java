...
/**
 * The type of readable octtrees with {@code long} integer coordinates.
 *
...
public interface OctTreeReadableLType<A> extends OctTreeReadableType
{
  ...
  <B> OctTreeReadableLType<B> map(BiFunction<A, BoundingVolumeL, B> f);
  ...
  BoundingVolumeL volumeFor(A item)
    throws NoSuchElementException;

  /**
   * Returns all objects in the tree that are completely contained within
   * {@code volume}, saving the results to {@code items}.
   *
