...
/**
 * The type of readable quadtrees with {@code int} coordinates.
 *
...
public interface QuadTreeReadableIType<A> extends QuadTreeReadableType
{
  /**
  ...
  <B> QuadTreeReadableIType<B> map(BiFunction<A, AreaI, B> f);
