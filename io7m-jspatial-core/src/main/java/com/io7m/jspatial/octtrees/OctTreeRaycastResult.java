...
public final class OctTreeRaycastResult<T extends BoundingVolumeType> implements
Comparable<OctTreeRaycastResult<T>>
{
  ...
  @Override public int compareTo(
    final @Nullable OctTreeRaycastResult<T> other)
  {
    return Double.compare(
      this.distance,
      NullCheck.notNull(other, "Other").distance);
  }
