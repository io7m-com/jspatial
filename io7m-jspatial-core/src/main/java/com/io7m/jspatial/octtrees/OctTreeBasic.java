 ...
 * {@link com.io7m.jspatial.quadtrees.QuadTreeBasic}.
 *
 * @param <T>
 *          The precise type of octtree members.
 */

@SuppressWarnings("synthetic-access") public final class OctTreeBasic<T extends OctTreeMemberType<T>> implements
OctTreeType<T>
{
