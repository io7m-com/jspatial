 ...
 * a minimum size limit on quadrants.
 * </p>
 *
 * @param <T>
...
@SuppressWarnings("synthetic-access") public final class QuadTreeSDLimit<T extends QuadTreeMemberType<T>> implements
  QuadTreeSDType<T>
{
  final class Quadrant implements QuadrantType
  {
    ...
    {
      final VectorI2I min = QuadTreeSDLimit.this.minimum_size;
  ...
  @SuppressWarnings("boxing") private QuadTreeSDLimit(
    final VectorReadable2IType position,
    final VectorReadable2IType size,
    final VectorReadable2IType size_minimum)
  {
