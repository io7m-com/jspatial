 ...
 * </p>
 * <p>
 * Note that although the <code>QuadTreeRaycastResultF</code> class is
...
@Immutable public final class QuadTreeRaycastResultF<T extends BoundingAreaF> implements
  Comparable<QuadTreeRaycastResultF<T>>
{
  private final double     distance;
  private final @Nonnull T object;

  QuadTreeRaycastResultF(
  ...
  @Override public int compareTo(
    final @Nonnull QuadTreeRaycastResultF<T> other)
  {
    ...
    final Object obj)
  {
    ...
    final QuadTreeRaycastResultF<?> other = (QuadTreeRaycastResultF<?>) obj;
