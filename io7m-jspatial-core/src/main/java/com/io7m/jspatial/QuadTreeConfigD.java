...
public final class QuadTreeConfigD
{
  ...
  public static final @Nonnull VectorReadable2D QUADTREE_DEFAULT_POSITION;
  ...
  static {
    ...
    QUADTREE_DEFAULT_POSITION = VectorI2D.ZERO;
  }

  /**
   * Initialize an empty configuration. The default values will build a
   * quadtree of size
   * <code>({@link QuadTreeConfigD#QUADTREE_DEFAULT_SIZE_X}, {@link QuadTreeConfigD#QUADTREE_DEFAULT_SIZE_Y})</code>
   * with a minimum quadrant size of
   * <code>({@link QuadTreeConfigD#QUADTREE_DEFAULT_MINIMUM_QUADRANT_SIZE_X}, {@link QuadTreeConfigD#QUADTREE_DEFAULT_MINIMUM_QUADRANT_SIZE_Y})</code>
   * .
   * 
   * Note that not all implementations will respect the minimum quadrant size.
   */

  public QuadTreeConfigD()
  {
    this.size =
      new VectorM2I(
        QuadTreeConfigD.QUADTREE_DEFAULT_SIZE_X,
        QuadTreeConfigD.QUADTREE_DEFAULT_SIZE_Y);
    this.minimum_size =
      new VectorM2I(
        QuadTreeConfigD.QUADTREE_DEFAULT_MINIMUM_QUADRANT_SIZE_X,
        QuadTreeConfigD.QUADTREE_DEFAULT_MINIMUM_QUADRANT_SIZE_Y);
    this.position = new VectorM2D(QuadTreeConfigD.QUADTREE_DEFAULT_POSITION);
  }
    ...
    final Object obj)
  {
    ...
    final QuadTreeConfigD other = (QuadTreeConfigD) obj;
  ...
  public @Nonnull VectorReadable2D getPosition()
  {
  ...
  @Override public String toString()
  {
    ...
    builder.append("[QuadTreeConfigF ");
