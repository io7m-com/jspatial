...
public final class QuadTreeConfigF
{
  ...
  public static final @Nonnull VectorReadable2F QUADTREE_DEFAULT_POSITION;
  ...
  static {
    ...
    QUADTREE_DEFAULT_POSITION = VectorI2F.ZERO;
  }

  /**
   * Initialize an empty configuration. The default values will build a
   * quadtree of size
   * <code>({@link QuadTreeConfigF#QUADTREE_DEFAULT_SIZE_X}, {@link QuadTreeConfigF#QUADTREE_DEFAULT_SIZE_Y})</code>
   * with a minimum quadrant size of
   * <code>({@link QuadTreeConfigF#QUADTREE_DEFAULT_MINIMUM_QUADRANT_SIZE_X}, {@link QuadTreeConfigF#QUADTREE_DEFAULT_MINIMUM_QUADRANT_SIZE_Y})</code>
   * .
   * 
   * Note that not all implementations will respect the minimum quadrant size.
   */

  public QuadTreeConfigF()
  {
    this.size =
      new VectorM2I(
        QuadTreeConfigF.QUADTREE_DEFAULT_SIZE_X,
        QuadTreeConfigF.QUADTREE_DEFAULT_SIZE_Y);
    this.minimum_size =
      new VectorM2I(
        QuadTreeConfigF.QUADTREE_DEFAULT_MINIMUM_QUADRANT_SIZE_X,
        QuadTreeConfigF.QUADTREE_DEFAULT_MINIMUM_QUADRANT_SIZE_Y);
    this.position = new VectorM2F(QuadTreeConfigF.QUADTREE_DEFAULT_POSITION);
  }
    ...
    final Object obj)
  {
    ...
    final QuadTreeConfigF other = (QuadTreeConfigF) obj;
  ...
  public @Nonnull VectorReadable2F getPosition()
  {
