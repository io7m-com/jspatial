...
import com.io7m.jspatial.OctTreePrune.Octants;
import com.io7m.jtensors.VectorI3D;
import com.io7m.jtensors.VectorI3I;
import com.io7m.jtensors.VectorReadable3I;

public class OctTreePruneTest
{
  ...
  @SuppressWarnings("static-method") @Test public void testClear()
    throws ConstraintError,
      Exception
  {
    final OctTreePrune<Cuboid> q = new OctTreePrune<Cuboid>(128, 128, 128);
    final Cuboid r0 =
  ...
  @SuppressWarnings("static-method") @Test public void testCountInitial()
    throws Exception,
      ConstraintError
  {
    final OctTreePrune<Cuboid> qt = new OctTreePrune<Cuboid>(8, 8, 8);
  ...
  @SuppressWarnings({ "static-method" }) @Test public void testCreate()
    throws ConstraintError
  {
    final OctTreePrune<Cuboid> q = new OctTreePrune<Cuboid>(2, 2, 2);
  ...
  @SuppressWarnings("static-method") @Test public void testInsertAtRoot()
    throws ConstraintError,
      Exception
  {
    final OctTreePrune<Cuboid> q = new OctTreePrune<Cuboid>(16, 16, 16);
    final Counter c = new Counter();
    final Cuboid r =
  ...
  @SuppressWarnings("static-method") @Test(expected = ConstraintError.class) public
    ...
    testInsertIllFormed()
      throws ConstraintError,
        Exception
  {
    OctTreePrune<Cuboid> q = null;
    Cuboid r = null;

    try {
      q = new OctTreePrune<Cuboid>(16, 16, 16);
  ...
  @SuppressWarnings("static-method") @Test public void testInsertImmediate()
    throws ConstraintError,
      Exception
  {
    final OctTreePrune<Cuboid> q = new OctTreePrune<Cuboid>(32, 32, 32);
