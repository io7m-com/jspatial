...
import com.io7m.jspatial.QuadTreeSimple.Quadrants;
import com.io7m.jtensors.VectorI2I;
import com.io7m.jtensors.VectorM2I;
import com.io7m.jtensors.VectorReadable2I;

public class QuadTreeSimpleTest
{
  ...
  @SuppressWarnings("static-method") @Test public void testClear()
    throws ConstraintError,
      Exception
  {
    final QuadTreeSimple<Rectangle> q =
      new QuadTreeSimple<Rectangle>(128, 128);
    final Rectangle r0 =
  ...
  @SuppressWarnings("static-method") @Test public void testCountInitial()
    throws Exception,
      ConstraintError
  {
    final QuadTreeSimple<Rectangle> qt = new QuadTreeSimple<Rectangle>(8, 8);
  ...
  @SuppressWarnings({ "static-method" }) @Test public void testCreate()
    throws ConstraintError
  {
    final QuadTreeSimple<Rectangle> q = new QuadTreeSimple<Rectangle>(2, 2);
  ...
  @SuppressWarnings({ "unused", "static-method" }) @Test(
    ...
    throws ConstraintError
  {
    new QuadTreeSimple<Rectangle>(3, 2);
  }
  ...
  @SuppressWarnings({ "unused", "static-method" }) @Test(
    ...
    throws ConstraintError
  {
    new QuadTreeSimple<Rectangle>(2, 3);
  }
  ...
  @SuppressWarnings({ "unused", "static-method" }) @Test(
    ...
    throws ConstraintError
  {
    new QuadTreeSimple<Rectangle>(1, 2);
  }
  ...
  @SuppressWarnings({ "unused", "static-method" }) @Test(
    ...
    throws ConstraintError
  {
    new QuadTreeSimple<Rectangle>(2, 1);
  }
  ...
  @SuppressWarnings("static-method") @Test public
    ...
    testInsertAtImmediateRootChildren()
      throws ConstraintError,
        Exception
  {
    final QuadTreeSimple<Rectangle> q = new QuadTreeSimple<Rectangle>(16, 16);
    final Counter c = new Counter();
    final Rectangle r0 =
...

    {
      ...
      Assert.assertEquals(8, QuadTreeSimple.getSpanSizeX(bal, bau));
      Assert.assertEquals(8, QuadTreeSimple.getSpanSizeY(bal, bau));
    }
  ...
  @SuppressWarnings("static-method") @Test(expected = ConstraintError.class) public
    ...
    testInsertIllFormed()
      throws ConstraintError,
        Exception
  {
    QuadTreeSimple<Rectangle> q = null;
    Rectangle r = null;

    try {
      q = new QuadTreeSimple<Rectangle>(16, 16);
  ...
  {
    final VectorM2I lower = new VectorM2I(8, 8);
    final VectorM2I upper = new VectorM2I(15, 15);
    final Quadrants q = QuadTreeSimple.splitQuadrants(lower, upper);
  ...
  @SuppressWarnings("static-method") @Test public void testSpan1D()
  {
    ...
    QuadTreeSimple.split1D(0, 3, spans);
  ...
  @SuppressWarnings("static-method") @Test public void testSpan1DVarious()
  {
    ...
    for (int i = 2; i < 30; ++i) {
      QuadTreeSimple.split1D(0, (1 << i) - 1, spans);
