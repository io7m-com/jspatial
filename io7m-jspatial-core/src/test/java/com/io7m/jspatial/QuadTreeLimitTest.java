...
import com.io7m.jspatial.QuadTreeLimit.Quadrants;
import com.io7m.jtensors.VectorI2D;
import com.io7m.jtensors.VectorI2I;
import com.io7m.jtensors.VectorReadable2I;

public class QuadTreeLimitTest
{
  ...
  @SuppressWarnings("static-method") @Test public void testClear()
    throws ConstraintError,
      Exception
  {
    final QuadTreeLimit<Rectangle> q =
      new QuadTreeLimit<Rectangle>(128, 128, 16, 16);
    final Rectangle r0 =
  ...
  @SuppressWarnings("static-method") @Test public void testCountInitial()
    throws Exception,
      ConstraintError
  {
    final QuadTreeLimit<Rectangle> qt =
      new QuadTreeLimit<Rectangle>(8, 8, 2, 2);
  ...
  {
    final QuadTreeLimit<Rectangle> q =
      new QuadTreeLimit<Rectangle>(2, 2, 2, 2);
  ...
  @SuppressWarnings({ "unused", "static-method" }) @Test(
    ...
    throws ConstraintError
  {
    new QuadTreeLimit<Rectangle>(4, 4, 3, 2);
  }
  ...
  @SuppressWarnings({ "unused", "static-method" }) @Test(
    ...
    throws ConstraintError
  {
    new QuadTreeLimit<Rectangle>(2, 2, 4, 2);
  }
  ...
  @SuppressWarnings({ "unused", "static-method" }) @Test(
    ...
    throws ConstraintError
  {
    new QuadTreeLimit<Rectangle>(2, 2, 1, 2);
  }
  ...
  @SuppressWarnings({ "unused", "static-method" }) @Test(
    ...
    throws ConstraintError
  {
    new QuadTreeLimit<Rectangle>(4, 4, 2, 3);
  }
  ...
  @SuppressWarnings({ "unused", "static-method" }) @Test(
    ...
    throws ConstraintError
  {
    new QuadTreeLimit<Rectangle>(2, 2, 2, 4);
  }
  ...
  @SuppressWarnings({ "unused", "static-method" }) @Test(
    ...
    throws ConstraintError
  {
    new QuadTreeLimit<Rectangle>(2, 2, 2, 1);
  }
  ...
  @SuppressWarnings({ "unused", "static-method" }) @Test(
    ...
    throws ConstraintError
  {
    new QuadTreeLimit<Rectangle>(3, 2, 2, 2);
  }
  ...
  @SuppressWarnings({ "unused", "static-method" }) @Test(
    ...
    throws ConstraintError
  {
    new QuadTreeLimit<Rectangle>(2, 3, 2, 2);
  }
  ...
  @SuppressWarnings({ "unused", "static-method" }) @Test(
    ...
    throws ConstraintError
  {
    new QuadTreeLimit<Rectangle>(1, 2, 2, 2);
  }
  ...
  @SuppressWarnings({ "unused", "static-method" }) @Test(
    ...
    throws ConstraintError
  {
    new QuadTreeLimit<Rectangle>(2, 1, 2, 2);
  }
  ...
  {
    final QuadTreeLimit<Rectangle> q =
      new QuadTreeLimit<Rectangle>(16, 16, 2, 2);
    final Counter c = new Counter();
    final Rectangle r0 =
  ...
  @SuppressWarnings("static-method") @Test(expected = ConstraintError.class) public
    ...
    testInsertIllFormed()
      throws ConstraintError,
        Exception
  {
    QuadTreeLimit<Rectangle> q = null;
    Rectangle r = null;

    try {
      q = new QuadTreeLimit<Rectangle>(16, 16, 2, 2);
  ...
  {
    final QuadTreeLimit<Rectangle> q =
      new QuadTreeLimit<Rectangle>(16, 16, 8, 8);
    final Rectangle r =
  ...
  {
    final QuadTreeLimit<Rectangle> q =
      new QuadTreeLimit<Rectangle>(128, 128, 2, 2);
    ...
    final QuadTreeRaycastResult<QuadTreeLimit<Rectangle>.Quadrant> rr =
      items.first();
    final QuadTreeLimit<Rectangle>.Quadrant qr = rr.getObject();
  ...
  {
    final QuadTreeLimit<Rectangle> q =
      new QuadTreeLimit<Rectangle>(512, 512, 2, 2);
  ...
  {
    final QuadTreeLimit<Rectangle> q =
      new QuadTreeLimit<Rectangle>(32, 32, 2, 2);
    final Rectangle r0 =
