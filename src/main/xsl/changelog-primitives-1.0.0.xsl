...
<xt:stylesheet
  ...
  xmlns:sp="http://www.io7m.com/schemas/site-primitives/2.0"
  ...
  <xt:template
    ...
    <sp:table-row>
      ...
      <sp:table-column>
        <xt:value-of
          select="concat('Release: ', ancestor::c:changelog/c:project, ' ', c:version)" />
      </sp:table-column>
    </sp:table-row>
    <xt:apply-templates
      select="c:item"
  ...
  <xt:template
    ...
    mode="io7m.changelog.primitives">
    <sp:section>
      <sp:section-title>Changes</sp:section-title>
      <sp:table>
        <sp:table-summary>Changes</sp:table-summary>
        <sp:table-head>
          <sp:table-column-name></sp:table-column-name>
          <sp:table-column-name></sp:table-column-name>
        </sp:table-head>
        <sp:table-body>
          <xt:apply-templates
