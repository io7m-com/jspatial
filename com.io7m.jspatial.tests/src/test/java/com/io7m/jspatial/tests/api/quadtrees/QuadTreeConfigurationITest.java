...
import com.io7m.jspatial.api.quadtrees.QuadTreeConfigurationIType;
...
/**
 * Contract completion for QuadTreeConfigurationI.
 */

public final class QuadTreeConfigurationITest extends
  QuadTreeConfigurationIContract
{
  @SuppressWarnings("unchecked")
  @Override
  protected <A extends QuadTreeConfigurationIType> Generator<A> generator()
  {
    return (Generator<A>) new QuadTreeConfigurationIGenerator();
  }

  @Override
  protected QuadTreeConfigurationIType create(final AreaI area)
  {
    final QuadTreeConfigurationI.Builder b = QuadTreeConfigurationI.builder();
    b.setArea(area);
    return b.build();
  }
  ...
  public void testBuilder()
  {
    ...
    final QuadTreeConfigurationI.Builder b0 = QuadTreeConfigurationI.builder();
    b0.setArea(area0);

    final QuadTreeConfigurationI qc0 = b0.build();
    ...
    b0.setMinimumQuadrantHeight(3);
    final QuadTreeConfigurationI qc1 = b0.build();
    ...
    b0.setMinimumQuadrantWidth(4);
    final QuadTreeConfigurationI qc2 = b0.build();
    ...
    final Vector2L lower1 = Vector2L.of(1, 1);
    final Vector2L upper1 = Vector2L.of(99, 99);
    final AreaI area1 = AreaI.of(1, 99, 1, 99);

    b0.setArea(area1);
    final QuadTreeConfigurationI qc3 = b0.build();
    ...
    final QuadTreeConfigurationI.Builder b1 = QuadTreeConfigurationI.builder();
    b1.from(qc3);

    final QuadTreeConfigurationI qc4 = b1.build();
  ...
  public void testWith()
  {
    ...
    final QuadTreeConfigurationI qc0 = b.build();
    final QuadTreeConfigurationI qc0_eq = b.build();

    final AreaI area1 = AreaI.of(1, 99, 1, 99);

    final QuadTreeConfigurationI qc1 = qc0.withArea(area1);
    final QuadTreeConfigurationI qc2 = qc0.withMinimumQuadrantWidth(4);
    final QuadTreeConfigurationI qc3 = qc0.withMinimumQuadrantHeight(3);
    final QuadTreeConfigurationI qc4 = qc0.withTrimOnRemove(true);
  ...
  public void testOf()
  {
    ...
    final QuadTreeConfigurationI qc1 =
      QuadTreeConfigurationI.of(area1, 2, 2, false);
    final QuadTreeConfigurationI qc2 =
      QuadTreeConfigurationI.of(area0, 4, 2, false);
    final QuadTreeConfigurationI qc3 =
      QuadTreeConfigurationI.of(area0, 2, 3, false);
    final QuadTreeConfigurationI qc4 =
      QuadTreeConfigurationI.of(area0, 2, 2, true);
  ...
  public void testCopyOf()
  {
    ...
    final QuadTreeConfigurationI qc0 = b.build();
    final QuadTreeConfigurationI qc1 = QuadTreeConfigurationI.copyOf(qc0);

    final QuadTreeConfigurationIType qc2 = QuadTreeConfigurationI.copyOf(
      new QuadTreeConfigurationIType()
      {
        @Override
        public AreaI area()
        {
